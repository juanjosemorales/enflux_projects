...
from arraydiff.array_diff.array_diff import calculate_difference_set
...
class Test_test(unittest.TestCase):
    ...
    def test_sample(self):
        list_a = [1,3,5,6,8,9]
        list_b = [1,2,5,7,9]
        diff = calculate_difference_set(list_a, list_b)
    ...
    def test_all_adds(self):
        ...
        list_b = [1, 1, 1, 1, 1, 2]
        diff = calculate_difference_set(list_a, list_b)
        self.assertListEqual(sorted(diff['additions']), [1, 2])
    ...
    def test_dels_and_adds_1(self):
        ...
        self.assertListEqual(sorted(diff['deletions']), [4,6,7])

    def test_dels_and_adds_2(self):
        list_a = [1,2,3,5]
        list_b = [1,2,3,4,6,7]
        diff = calculate_difference_set(list_a,list_b)
        self.assertListEqual(sorted(diff['additions']), [4,6,7])
